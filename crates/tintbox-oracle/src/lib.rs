...
//! for bit-for-bit comparison against `tintbox`.

unsafe extern "C" {
    // TEMPORARY transcendental parity probe (slice 3 de-risk). KEPT.
    fn tintbox_oracle_pow(x: f64, y: f64) -> f64;
    fn tintbox_oracle_log(x: f64) -> f64;
    fn tintbox_oracle_log10(x: f64) -> f64;
    fn tintbox_oracle_eval_parametric(ty: i32, params: *const f64, nparams: i32, x: f32) -> f32;
    fn tintbox_oracle_tabulated16_eval16(table: *const u16, n: u32, v: u16) -> u16;
    fn tintbox_oracle_tabulated16_eval_float(table: *const u16, n: u32, x: f32) -> f32;
    fn tintbox_oracle_tabulated_float_eval_float(table: *const f32, n: u32, x: f32) -> f32;
    fn tintbox_oracle_parametric_eval_float(ty: i32, params: *const f64, x: f32) -> f32;
    fn tintbox_oracle_parametric_table16(
        ty: i32,
        params: *const f64,
        out: *mut u16,
        cap: u32,
    ) -> i32;
    fn tintbox_oracle_tabulated_float_table16(
        table: *const f32,
        n_in: u32,
        out: *mut u16,
        cap: u32,
    ) -> i32;
    fn tintbox_oracle_double_to_s15f16(v: f64) -> i32;
    fn tintbox_oracle_s15f16_to_double(a: i32) -> f64;
    fn tintbox_oracle_double_to_8fixed8(v: f64) -> u16;
    fn tintbox_oracle_to_fixed_domain(a: i32) -> i32;
    fn tintbox_oracle_from_fixed_domain(a: i32) -> i32;
    fn tintbox_oracle_quick_floor(v: f64) -> i32;
    fn tintbox_oracle_quick_floor_word(d: f64) -> u16;
    fn tintbox_oracle_quick_saturate_word(d: f64) -> u16;
    fn tintbox_oracle_xyz2lab(wp: *const f64, xyz: *const f64, lab: *mut f64);
    fn tintbox_oracle_lab2xyz(wp: *const f64, lab: *const f64, xyz: *mut f64);
    fn tintbox_oracle_xyz2xyy(xyz: *const f64, xyy: *mut f64);
    ...
    fn tintbox_oracle_float2lab_enc_v2(lab: *const f64, wlab: *mut u16);
    fn tintbox_oracle_xyz_enc2float(wxyz: *const u16, xyz: *mut f64);
    fn tintbox_oracle_float2xyz_enc(xyz: *const f64, wxyz: *mut u16);
    fn tintbox_oracle_mat3_eval(out: *mut f64, m: *const f64, v: *const f64);
    fn tintbox_oracle_mat3_per(out: *mut f64, a: *const f64, b: *const f64);
    fn tintbox_oracle_mat3_inverse(out: *mut f64, a: *const f64) -> i32;
    fn tintbox_oracle_mat3_solve(out: *mut f64, a: *const f64, b: *const f64) -> i32;
    fn tintbox_oracle_white_point_from_temp(out: *mut f64, temp_k: f64) -> i32;
    fn tintbox_oracle_adapt_to_illuminant(
        out: *mut f64,
        src_wp: *const f64,
        illuminant: *const f64,
        value: *const f64,
    ) -> i32;
    fn tintbox_oracle_adaptation_matrix(out: *mut f64, from: *const f64, to: *const f64) -> i32;
    fn tintbox_oracle_half_to_float(h: u16) -> f32;
    fn tintbox_oracle_float_to_half(f: f32) -> u16;
    fn tintbox_oracle_md5(out: *mut u8, buf: *const u8, len: u32);
    fn tintbox_oracle_read_u16(buf: *const u8, len: u32, out: *mut u16) -> i32;
    fn tintbox_oracle_read_u32(buf: *const u8, len: u32, out: *mut u32) -> i32;
    fn tintbox_oracle_read_u8(buf: *const u8, len: u32, out: *mut u8) -> i32;
    fn tintbox_oracle_read_u64(buf: *const u8, len: u32, out: *mut u64) -> i32;
    fn tintbox_oracle_read_s15f16(buf: *const u8, len: u32, out: *mut i32) -> i32;
    fn tintbox_oracle_read_xyz(buf: *const u8, len: u32, out: *mut f64) -> i32;
    fn tintbox_oracle_read_u16_array(buf: *const u8, len: u32, n: u32, out: *mut u16) -> i32;
    fn tintbox_oracle_read_type_base(buf: *const u8, len: u32, out: *mut u32) -> i32;
    fn tintbox_oracle_read_alignment(
        buf: *const u8,
        len: u32,
        offset: u32,
        out_tell: *mut u32,
    ) -> i32;
    fn tintbox_oracle_read_header(buf: *const u8, len: u32, out: *mut OracleHeader) -> i32;
    fn tintbox_oracle_open_succeeds(buf: *const u8, len: u32) -> i32;
    fn tintbox_oracle_tag_count(buf: *const u8, len: u32) -> i32;
    fn tintbox_oracle_tag_signature(buf: *const u8, len: u32, n: u32) -> u32;
    fn tintbox_oracle_tag_true_type(buf: *const u8, len: u32, sig: u32) -> u32;
    fn tintbox_oracle_tag_read_succeeds(buf: *const u8, len: u32, sig: u32) -> i32;
    fn tintbox_oracle_save_basic_profile(link: i32, out: *mut u8, cap: u32) -> u32;
    fn tintbox_oracle_save_single_tag(which: i32, out: *mut u8, cap: u32) -> u32;
    fn tintbox_oracle_save_curve_mlu_tag(which: i32, out: *mut u8, cap: u32) -> u32;
    fn tintbox_oracle_resave_lut_tag(
        src: *const u8,
        len: u32,
        src_sig: u32,
        dst_sig: u32,
    ...
    fn tintbox_oracle_save_mpe_tag(out: *mut u8, cap: u32) -> u32;
    fn tintbox_oracle_save_virtual_profile(which: i32, out: *mut u8, cap: u32) -> u32;
    fn tintbox_oracle_tetra16(
        grid: *const u32,
        n_out: u32,
        table: *const u16,
        table_len: u32,
    ...
    fn tintbox_oracle_interp_float(
        grid: *const u32,
        n_in: u32,
        n_out: u32,
        table: *const f32,
    ...
    fn tintbox_oracle_read_tag_xyz(buf: *const u8, len: u32, sig: u32, out: *mut f64) -> i32;
    fn tintbox_oracle_read_tag_s15f16(
        buf: *const u8,
        len: u32,
        sig: u32,
        out: *mut f64,
    ...
    fn tintbox_oracle_read_tag_signature(buf: *const u8, len: u32, sig: u32, out: *mut u32) -> i32;
    fn tintbox_oracle_read_tag_text(
        buf: *const u8,
        len: u32,
        sig: u32,
        out: *mut u8,
    ...
    fn tintbox_oracle_read_tag_data(
        buf: *const u8,
        len: u32,
        sig: u32,
        flag: *mut u32,
    ...
    fn tintbox_oracle_read_tag_datetime(buf: *const u8, len: u32, sig: u32, out: *mut u16) -> i32;
    fn tintbox_oracle_read_tag_chromaticity(
        buf: *const u8,
        len: u32,
        sig: u32,
        out: *mut f64,
    ) -> i32;
    fn tintbox_oracle_read_tag_colorant_order(
        buf: *const u8,
        len: u32,
        sig: u32,
        out: *mut u8,
    ...
    fn tintbox_oracle_read_tag_measurement(
        buf: *const u8,
        len: u32,
        sig: u32,
        out_u32: *mut u32,
    ...
    fn tintbox_oracle_mlu_count(buf: *const u8, len: u32, sig: u32) -> i32;
    fn tintbox_oracle_mlu_entry(
        buf: *const u8,
        len: u32,
        sig: u32,
        idx: u32,
    ...
    fn tintbox_oracle_named_color2_info(
        buf: *const u8,
        len: u32,
        sig: u32,
        out_counts: *mut u32,
    ...
    fn tintbox_oracle_named_color2_color(
        buf: *const u8,
        len: u32,
        sig: u32,
        idx: u32,
    ...
    fn tintbox_oracle_seq_count(buf: *const u8, len: u32, sig: u32) -> i32;
    fn tintbox_oracle_seq_desc_elem(
        buf: *const u8,
        len: u32,
        sig: u32,
        idx: u32,
    ...
    fn tintbox_oracle_read_tag_curve(
        buf: *const u8,
        len: u32,
        sig: u32,
        xs: *const f32,
    ...
    fn tintbox_oracle_read_tag_vcgt(
        buf: *const u8,
        len: u32,
        sig: u32,
        xs: *const f32,
    ...
    fn tintbox_oracle_read_tag_ucrbg(
        buf: *const u8,
        len: u32,
        sig: u32,
        xs: *const f32,
    ...
    fn tintbox_oracle_dict_count(buf: *const u8, len: u32, sig: u32) -> i32;
    fn tintbox_oracle_dict_entry(
        buf: *const u8,
        len: u32,
        sig: u32,
        idx: u32,
    ...
    fn tintbox_oracle_pipeline_matrix_eval16(
        rows: u32,
        cols: u32,
        matrix: *const f64,
        offset: *const f64,
    ...
    fn tintbox_oracle_pipeline_matrix_eval_float(
        rows: u32,
        cols: u32,
        matrix: *const f64,
        offset: *const f64,
    ...
    fn tintbox_oracle_pipeline_curves_eval16(
        n_curves: u32,
        tbl_len: u32,
        tables: *const u16,
        input: *const u16,
    ...
    fn tintbox_oracle_pipeline_curves_eval_float(
        n_curves: u32,
        tbl_len: u32,
        tables: *const u16,
        input: *const f32,
    ...
    fn tintbox_oracle_pipeline_curves_matrix_eval16(
        n_curves: u32,
        tbl_len: u32,
        tables: *const u16,
        rows: u32,
    ...
    fn tintbox_oracle_pipeline_curves_matrix_eval_float(
        n_curves: u32,
        tbl_len: u32,
        tables: *const u16,
        rows: u32,
    ...
    fn tintbox_oracle_clut_stage_eval16(
        grid: *const u32,
        n_in: u32,
        n_out: u32,
        table: *const u16,
    ...
    fn tintbox_oracle_clut_stage_eval_float(
        grid: *const u32,
        n_in: u32,
        n_out: u32,
        table: *const f32,
    ...
    fn tintbox_oracle_labxyz_stage_eval(which: u32, input: *const f32, out: *mut f32) -> i32;
    #[allow(clippy::too_many_arguments)]
    fn tintbox_oracle_pipeline_clut_curves_matrix_eval_float(
        grid: *const u32,
        n_in: u32,
        n_out: u32,
    ...
    #[allow(clippy::too_many_arguments)]
    fn tintbox_oracle_pipeline_cat_eval_float(
        tbl_len: u32,
        curve_tables: *const u16,
        mat_a: *const f64,
        off_a: *const f64,
    ...
    fn tintbox_oracle_pipeline_prepend_eval_float(
        tbl_len: u32,
        curve_tables: *const u16,
        mat_a: *const f64,
        off_a: *const f64,
    ...
    fn tintbox_oracle_lut_channels(
        buf: *const u8,
        len: u32,
        sig: u32,
        n_in: *mut u32,
    ...
    fn tintbox_oracle_lut_eval_float(
        buf: *const u8,
        len: u32,
        sig: u32,
        inputs: *const f32,
    ...
    fn tintbox_oracle_read_lut_channels(
        buf: *const u8,
        len: u32,
        which: u32,
        intent: u32,
    ...
    fn tintbox_oracle_read_lut_eval_float(
        buf: *const u8,
        len: u32,
        which: u32,
        intent: u32,
    ...
    fn tintbox_oracle_reverse_tabulated16_eval_float(
        table: *const u16,
        n: u32,
        xs: *const f32,
        nx: u32,
    ...
    #[allow(clippy::too_many_arguments)]
    fn tintbox_oracle_transform_eval_float(
        bufs: *const *const u8,
        lens: *const u32,
        n: u32,
        intents: *const u32,
    ...
    #[allow(clippy::too_many_arguments)]
    fn tintbox_oracle_transform_eval_16(
        bufs: *const *const u8,
        lens: *const u32,
        n: u32,
        intents: *const u32,
    ...
    fn tintbox_oracle_unpack16(fmt: u32, buf: *const u8, out: *mut u16);
    fn tintbox_oracle_pack16(fmt: u32, values: *const u16, out: *mut u8, nbytes: *mut u32);

    // Float/double pixel-format formatters (CMS_PACK_FLAGS_FLOAT).
    fn tintbox_oracle_unpack_float(fmt: u32, buf: *const u8, out: *mut f32);
    fn tintbox_oracle_pack_float(fmt: u32, values: *const f32, out: *mut u8, nbytes: *mut u32);

    // Format-aware do_transform (NOOPTIMIZE) over packed byte buffers.
    #[allow(clippy::too_many_arguments)]
    fn tintbox_oracle_do_transform_packed(
        bufs: *const *const u8,
        lens: *const u32,
        n: u32,
        intents: *const u32,
    ...
    #[allow(clippy::too_many_arguments)]
    fn tintbox_oracle_do_transform_packed_copyalpha(
        bufs: *const *const u8,
        lens: *const u32,
        n: u32,
        intents: *const u32,
    ...
    #[allow(clippy::too_many_arguments)]
    fn tintbox_oracle_transform_eval_default_8(
        bufs: *const *const u8,
        lens: *const u32,
        n: u32,
        intents: *const u32,
    ...
    #[allow(clippy::too_many_arguments)]
    fn tintbox_oracle_transform_eval_default_16(
        bufs: *const *const u8,
        lens: *const u32,
        n: u32,
        intents: *const u32,
    ...
    fn tintbox_oracle_from_8_to_16(v: u8) -> u16;
    fn tintbox_oracle_from_16_to_8(v: u16) -> u8;
    ...
    fn tintbox_oracle_detect_black_point(
        bytes: *const u8,
        len: u32,
        intent: u32,
        flags: u32,
    ...
    fn tintbox_oracle_detect_destination_black_point(
        bytes: *const u8,
        len: u32,
        intent: u32,
        flags: u32,
    ...
    fn tintbox_oracle_cam02_forward(h: *mut core::ffi::c_void, xyz: *const f64, jch: *mut f64);
    fn tintbox_oracle_cam02_reverse(h: *mut core::ffi::c_void, jch: *const f64, xyz: *mut f64);
    fn tintbox_oracle_cam02_done(h: *mut core::ffi::c_void);

    // ==== slice9-ps ====
    // PostScript CSA/CRD generation (cmsps2.c). Two-call: NULL out -> byte count.
    fn tintbox_oracle_get_postscript_csa(
        bytes: *const u8,
        len: u32,
        intent: u32,
        flags: u32,
    ...
    fn tintbox_oracle_get_postscript_crd(
        bytes: *const u8,
        len: u32,
        intent: u32,
        flags: u32,
    ...
    fn tintbox_oracle_named_transform_16(
...
pub fn detect_black_point(bytes: &[u8], intent: u32, flags: u32) -> (bool, [f64; 3]) {
    ...
    let ok = unsafe {
        tintbox_oracle_detect_black_point(
            bytes.as_ptr(),
            bytes.len() as u32,
            intent,
            flags,
...
pub fn detect_destination_black_point(bytes: &[u8], intent: u32, flags: u32) -> (bool, [f64; 3]) {
    let mut out = [0.0f64; 3];
    let ok = unsafe {
        tintbox_oracle_detect_destination_black_point(
            bytes.as_ptr(),
            bytes.len() as u32,
            intent,
            flags,
...
fn get_postscript(bytes: &[u8], intent: u32, flags: u32, crd: bool) -> Option<Vec<u8>> {
    ...
    let needed = unsafe {
        let f = if crd {
            tintbox_oracle_get_postscript_crd
        } else {
            tintbox_oracle_get_postscript_csa
        };
        f(
            bytes.as_ptr(),
            bytes.len() as u32,
...
/// `MatShaperEval16` 1.14-fixed evaluator — the reference for tintbox's
...
/// reference for tintbox's `OptimizationStrategy::Lcms2Compat` over arbitrary
...
fn do_transform_packed_default_impl(
    ...
    let ok = unsafe {
        if use_16 {
            tintbox_oracle_transform_eval_default_16(
                bufs.as_ptr(),
                lens.as_ptr(),
                n as u32,
                intents.as_ptr(),
            ...
            tintbox_oracle_transform_eval_default_8(
                bufs.as_ptr(),
                lens.as_ptr(),
                n as u32,
                intents.as_ptr(),
...
pub fn from_8_to_16(v: u8) -> u16 {
    ...
    unsafe { tintbox_oracle_from_8_to_16(v) }
}

/// lcms2 `FROM_16_TO_8` (lcms2_internal.h:126).
pub fn from_16_to_8(v: u16) -> u8 {
    // SAFETY: pure arithmetic macro, no pointers.
    unsafe { tintbox_oracle_from_16_to_8(v) }
}
...
pub fn unpack16(fmt: u32, buf: &[u8]) -> [u16; MAX_CHANNELS] {
    ...
    unsafe {
        tintbox_oracle_unpack16(fmt, buf.as_ptr(), out.as_mut_ptr());
    }
    out
}
...
pub fn pack16(fmt: u32, values: &[u16; MAX_CHANNELS], out: &mut [u8]) -> usize {
    ...
    unsafe {
        tintbox_oracle_pack16(fmt, values.as_ptr(), out.as_mut_ptr(), &mut nbytes);
    }
    nbytes as usize
}
...
pub fn unpack_float(fmt: u32, buf: &[u8]) -> [f32; MAX_CHANNELS] {
    ...
    unsafe {
        tintbox_oracle_unpack_float(fmt, buf.as_ptr(), out.as_mut_ptr());
    }
    out
}
...
pub fn pack_float(fmt: u32, values: &[f32; MAX_CHANNELS], out: &mut [u8]) -> usize {
    ...
    unsafe {
        tintbox_oracle_pack_float(fmt, values.as_ptr(), out.as_mut_ptr(), &mut nbytes);
    }
    nbytes as usize
}
...
pub fn do_transform_packed(
    ...
    let ok = unsafe {
        tintbox_oracle_do_transform_packed(
            bufs.as_ptr(),
            lens.as_ptr(),
            n as u32,
            intents.as_ptr(),
...
/// color-transforming them. The reference for tintbox's COPY_ALPHA extra-channel
...
pub fn do_transform_packed_copyalpha(
    ...
    let ok = unsafe {
        tintbox_oracle_do_transform_packed_copyalpha(
            bufs.as_ptr(),
            lens.as_ptr(),
            n as u32,
            intents.as_ptr(),
...
/// Flat mirror of `tintbox_oracle_header` in shim.c (must match field order/layout).
...
pub fn read_header(buf: &[u8]) -> Option<OracleHeader> {
    ...
    // `OracleHeader` whose layout matches the C `tintbox_oracle_header` (both repr(C),
    ...
    let ok = unsafe { tintbox_oracle_read_header(buf.as_ptr(), buf.len() as u32, &mut out) };
    if ok != 0 {
        Some(out)
    } else {
        None
...
pub fn open_succeeds(buf: &[u8]) -> bool {
    ...
    let ok = unsafe { tintbox_oracle_open_succeeds(buf.as_ptr(), buf.len() as u32) };
    ok != 0
}
...
pub fn tag_count(buf: &[u8]) -> Option<u32> {
    ...
    let n = unsafe { tintbox_oracle_tag_count(buf.as_ptr(), buf.len() as u32) };
    if n < 0 {
        None
    } else {
        Some(n as u32)
...
pub fn tag_signatures(buf: &[u8]) -> Option<Vec<u32>> {
    ...
    for i in 0..n {
        ...
        let sig = unsafe { tintbox_oracle_tag_signature(buf.as_ptr(), buf.len() as u32, i) };
        sigs.push(sig);
    }
    Some(sigs)
}
...
pub fn eval_parametric(ty: i32, params: &[f64], x: f32) -> Option<f32> {
    ...
    let y = unsafe { tintbox_oracle_eval_parametric(ty, params.as_ptr(), params.len() as i32, x) };
    if y.is_nan() {
        None
    } else {
        Some(y)
...
pub fn tabulated16_eval16(table: &[u16], v: u16) -> u16 {
    ...
    unsafe { tintbox_oracle_tabulated16_eval16(table.as_ptr(), table.len() as u32, v) }
}
...
pub fn tabulated16_eval_float(table: &[u16], x: f32) -> f32 {
    ...
    unsafe { tintbox_oracle_tabulated16_eval_float(table.as_ptr(), table.len() as u32, x) }
}
...
pub fn tabulated_float_eval_float(table: &[f32], x: f32) -> Option<f32> {
    ...
    // built and freed inside the call.
    let y =
        unsafe { tintbox_oracle_tabulated_float_eval_float(table.as_ptr(), table.len() as u32, x) };
    if y.is_nan() {
        None
    } else {
        Some(y)
...
pub fn parametric_eval_float(ty: i32, params: &[f64], x: f32) -> Option<f32> {
    ...
    let y = unsafe { tintbox_oracle_parametric_eval_float(ty, params.as_ptr(), x) };
    if y.is_nan() {
        None
    } else {
        Some(y)
...
pub fn parametric_table16(ty: i32, params: &[f64]) -> Option<Vec<u16>> {
    ...
    let n = unsafe {
        tintbox_oracle_parametric_table16(ty, params.as_ptr(), out.as_mut_ptr(), cap as u32)
    };
    if n < 0 {
        None
    } else {
...
pub fn pipeline_matrix_eval16(
    ...
    let ok = unsafe {
        tintbox_oracle_pipeline_matrix_eval16(
            rows as u32,
            cols as u32,
            matrix.as_ptr(),
            off_ptr,
...
pub fn pipeline_matrix_eval_float(
    ...
    let ok = unsafe {
        tintbox_oracle_pipeline_matrix_eval_float(
            rows as u32,
            cols as u32,
            matrix.as_ptr(),
            off_ptr,
...
pub fn pipeline_curves_eval16(
    ...
    let ok = unsafe {
        tintbox_oracle_pipeline_curves_eval16(
            n_curves as u32,
            tbl_len as u32,
            tables.as_ptr(),
            input.as_ptr(),
...
pub fn pipeline_curves_eval_float(
    ...
    let ok = unsafe {
        tintbox_oracle_pipeline_curves_eval_float(
            n_curves as u32,
            tbl_len as u32,
            tables.as_ptr(),
            input.as_ptr(),
...
pub fn pipeline_curves_matrix_eval16(
    ...
    let ok = unsafe {
        tintbox_oracle_pipeline_curves_matrix_eval16(
            n_curves as u32,
            tbl_len as u32,
            tables.as_ptr(),
            rows as u32,
...
pub fn pipeline_curves_matrix_eval_float(
    ...
    let ok = unsafe {
        tintbox_oracle_pipeline_curves_matrix_eval_float(
            n_curves as u32,
            tbl_len as u32,
            tables.as_ptr(),
            rows as u32,
...
pub fn clut_stage_eval16(
    ...
    let ok = unsafe {
        tintbox_oracle_clut_stage_eval16(
            grid.as_ptr(),
            grid.len() as u32,
            n_out as u32,
            table.as_ptr(),
...
pub fn clut_stage_eval_float(
    ...
    let ok = unsafe {
        tintbox_oracle_clut_stage_eval_float(
            grid.as_ptr(),
            grid.len() as u32,
            n_out as u32,
            table.as_ptr(),
...
pub fn labxyz_stage_eval(which: u32, input: &[f32; 3]) -> Option<[f32; 3]> {
    ...
    let ok = unsafe { tintbox_oracle_labxyz_stage_eval(which, input.as_ptr(), out.as_mut_ptr()) };
    if ok != 0 {
        Some(out)
    } else {
        None
...
pub fn pipeline_clut_curves_matrix_eval_float(
    ...
    let ok = unsafe {
        tintbox_oracle_pipeline_clut_curves_matrix_eval_float(
            grid.as_ptr(),
            grid.len() as u32,
            n_out as u32,
            clut_table.as_ptr(),
...
pub fn pipeline_cat_eval_float(
    ...
    let ok = unsafe {
        tintbox_oracle_pipeline_cat_eval_float(
            tbl_len as u32,
            curve_tables.as_ptr(),
            mat.as_ptr(),
            off_ptr,
...
pub fn pipeline_prepend_eval_float(
    ...
    let ok = unsafe {
        tintbox_oracle_pipeline_prepend_eval_float(
            tbl_len as u32,
            curve_tables.as_ptr(),
            mat.as_ptr(),
            off_ptr,
...
pub fn tabulated_float_table16(table: &[f32]) -> Option<Vec<u16>> {
    ...
    let n = unsafe {
        tintbox_oracle_tabulated_float_table16(
            table.as_ptr(),
            table.len() as u32,
            out.as_mut_ptr(),
            cap as u32,
...
pub fn double_to_s15f16(v: f64) -> i32 {
    // SAFETY: pure C arithmetic, no pointers, no allocation.
    unsafe { tintbox_oracle_double_to_s15f16(v) }
}
pub fn s15f16_to_double(a: i32) -> f64 {
    // SAFETY: pure C arithmetic, no pointers, no allocation.
    unsafe { tintbox_oracle_s15f16_to_double(a) }
}
pub fn double_to_8fixed8(v: f64) -> u16 {
    // SAFETY: pure C arithmetic, no pointers, no allocation.
    unsafe { tintbox_oracle_double_to_8fixed8(v) }
}
pub fn to_fixed_domain(a: i32) -> i32 {
    // SAFETY: pure C arithmetic, no pointers, no allocation.
    unsafe { tintbox_oracle_to_fixed_domain(a) }
}
pub fn from_fixed_domain(a: i32) -> i32 {
    // SAFETY: pure C arithmetic, no pointers, no allocation.
    unsafe { tintbox_oracle_from_fixed_domain(a) }
}

/// lcms2 `_cmsQuickFloor`.
pub fn quick_floor(v: f64) -> i32 {
    // SAFETY: pure C arithmetic, no pointers, no allocation.
    unsafe { tintbox_oracle_quick_floor(v) }
}
/// lcms2 `_cmsQuickFloorWord`.
pub fn quick_floor_word(d: f64) -> u16 {
    // SAFETY: pure C arithmetic, no pointers, no allocation.
    unsafe { tintbox_oracle_quick_floor_word(d) }
}
/// lcms2 `_cmsQuickSaturateWord`.
pub fn quick_saturate_word(d: f64) -> u16 {
    // SAFETY: pure C arithmetic, no pointers, no allocation.
    unsafe { tintbox_oracle_quick_saturate_word(d) }
}
...
pub fn xyz2lab(wp: Option<[f64; 3]>, xyz: &[f64; 3]) -> [f64; 3] {
    ...
    unsafe { tintbox_oracle_xyz2lab(wp_ptr, xyz.as_ptr(), out.as_mut_ptr()) };
    out
}
...
pub fn lab2xyz(wp: Option<[f64; 3]>, lab: &[f64; 3]) -> [f64; 3] {
    ...
    unsafe { tintbox_oracle_lab2xyz(wp_ptr, lab.as_ptr(), out.as_mut_ptr()) };
    out
}
...
pub fn xyz2xyy(xyz: &[f64; 3]) -> [f64; 3] {
    ...
    unsafe { tintbox_oracle_xyz2xyy(xyz.as_ptr(), out.as_mut_ptr()) };
    out
}
...
pub fn xyy2xyz(xyy: &[f64; 3]) -> [f64; 3] {
    ...
    unsafe { tintbox_oracle_xyy2xyz(xyy.as_ptr(), out.as_mut_ptr()) };
    out
}
...
pub fn lch2lab(lch: &[f64; 3]) -> [f64; 3] {
    ...
    unsafe { tintbox_oracle_lch2lab(lch.as_ptr(), out.as_mut_ptr()) };
    out
}
...
pub fn lab_enc2float_v4(wlab: &[u16; 3]) -> [f64; 3] {
    ...
    unsafe { tintbox_oracle_lab_enc2float_v4(wlab.as_ptr(), out.as_mut_ptr()) };
    out
}
...
pub fn float2lab_enc_v4(lab: &[f64; 3]) -> [u16; 3] {
    ...
    unsafe { tintbox_oracle_float2lab_enc_v4(lab.as_ptr(), out.as_mut_ptr()) };
    out
}
...
pub fn lab_enc2float_v2(wlab: &[u16; 3]) -> [f64; 3] {
    let mut out = [0.0f64; 3];
    // SAFETY: wlab is a valid 3-u16 array C reads; out a valid 3-double array C writes.
    unsafe { tintbox_oracle_lab_enc2float_v2(wlab.as_ptr(), out.as_mut_ptr()) };
    out
}
...
pub fn float2lab_enc_v2(lab: &[f64; 3]) -> [u16; 3] {
    let mut out = [0u16; 3];
    // SAFETY: lab is a valid 3-double array C reads; out a valid 3-u16 array C writes.
    unsafe { tintbox_oracle_float2lab_enc_v2(lab.as_ptr(), out.as_mut_ptr()) };
    out
}
...
pub fn xyz_enc2float(wxyz: &[u16; 3]) -> [f64; 3] {
    ...
    unsafe { tintbox_oracle_xyz_enc2float(wxyz.as_ptr(), out.as_mut_ptr()) };
    out
}
...
pub fn float2xyz_enc(xyz: &[f64; 3]) -> [u16; 3] {
    ...
    unsafe { tintbox_oracle_float2xyz_enc(xyz.as_ptr(), out.as_mut_ptr()) };
    out
}
...
pub fn mat3_eval(m: &[f64; 9], v: &[f64; 3]) -> [f64; 3] {
    ...
    unsafe {
        tintbox_oracle_mat3_eval(out.as_mut_ptr(), m.as_ptr(), v.as_ptr());
    }
    out
}
/// lcms2 `_cmsMAT3per`.
pub fn mat3_per(a: &[f64; 9], b: &[f64; 9]) -> [f64; 9] {
    ...
    unsafe {
        tintbox_oracle_mat3_per(out.as_mut_ptr(), a.as_ptr(), b.as_ptr());
    }
    out
}
...
pub fn mat3_inverse(a: &[f64; 9]) -> Option<[f64; 9]> {
    ...
    let ok = unsafe { tintbox_oracle_mat3_inverse(out.as_mut_ptr(), a.as_ptr()) };
    if ok != 0 {
        Some(out)
    } else {
        None
...
pub fn mat3_solve(a: &[f64; 9], b: &[f64; 3]) -> Option<[f64; 3]> {
    ...
    let ok = unsafe { tintbox_oracle_mat3_solve(out.as_mut_ptr(), a.as_ptr(), b.as_ptr()) };
    if ok != 0 {
        Some(out)
    } else {
        None
...
pub fn white_point_from_temp(temp_k: f64) -> Option<[f64; 3]> {
    ...
    let ok = unsafe { tintbox_oracle_white_point_from_temp(out.as_mut_ptr(), temp_k) };
    if ok != 0 {
        Some(out)
    } else {
        None
...
pub fn adapt_to_illuminant(
    ...
    // C writes 3 doubles to out only when it returns nonzero.
    let ok = unsafe {
        tintbox_oracle_adapt_to_illuminant(
            out.as_mut_ptr(),
            src_wp.as_ptr(),
            illuminant.as_ptr(),
            value.as_ptr(),
...
pub fn adaptation_matrix(from: &[f64; 3], to: &[f64; 3]) -> Option<[f64; 9]> {
    ...
    let ok =
        unsafe { tintbox_oracle_adaptation_matrix(out.as_mut_ptr(), from.as_ptr(), to.as_ptr()) };
    if ok != 0 {
        Some(out)
    } else {
        None
...
pub fn half_to_float(h: u16) -> f32 {
    // SAFETY: pure C arithmetic, no pointers, no allocation.
    unsafe { tintbox_oracle_half_to_float(h) }
}
/// lcms2 `_cmsFloat2Half`.
pub fn float_to_half(f: f32) -> u16 {
    // SAFETY: pure C arithmetic, no pointers, no allocation.
    unsafe { tintbox_oracle_float_to_half(f) }
}
...
pub fn md5(buf: &[u8]) -> [u8; 16] {
    ...
    unsafe {
        tintbox_oracle_md5(out.as_mut_ptr(), buf.as_ptr(), buf.len() as u32);
    }
    out
}
...
pub fn read_u16(buf: &[u8]) -> Option<u16> {
    ...
    let ok = unsafe { tintbox_oracle_read_u16(buf.as_ptr(), buf.len() as u32, &mut out) };
    if ok != 0 {
        Some(out)
    } else {
        None
...
pub fn read_u32(buf: &[u8]) -> Option<u32> {
    ...
    let ok = unsafe { tintbox_oracle_read_u32(buf.as_ptr(), buf.len() as u32, &mut out) };
    if ok != 0 {
        Some(out)
    } else {
        None
...
pub fn read_u8(buf: &[u8]) -> Option<u8> {
    ...
    let ok = unsafe { tintbox_oracle_read_u8(buf.as_ptr(), buf.len() as u32, &mut out) };
    if ok != 0 {
        Some(out)
    } else {
        None
...
pub fn read_u64(buf: &[u8]) -> Option<u64> {
    ...
    let ok = unsafe { tintbox_oracle_read_u64(buf.as_ptr(), buf.len() as u32, &mut out) };
    if ok != 0 {
        Some(out)
    } else {
        None
...
pub fn read_s15f16(buf: &[u8]) -> Option<i32> {
    ...
    let ok = unsafe { tintbox_oracle_read_s15f16(buf.as_ptr(), buf.len() as u32, &mut out) };
    if ok != 0 {
        Some(out)
    } else {
        None
...
pub fn read_xyz(buf: &[u8]) -> Option<[f64; 3]> {
    ...
    let ok = unsafe { tintbox_oracle_read_xyz(buf.as_ptr(), buf.len() as u32, out.as_mut_ptr()) };
    if ok != 0 {
        Some(out)
    } else {
        None
...
pub fn read_u16_array(buf: &[u8], n: usize) -> Option<Vec<u16>> {
    ...
    let ok = unsafe {
        tintbox_oracle_read_u16_array(buf.as_ptr(), buf.len() as u32, n as u32, out.as_mut_ptr())
    };
    if ok != 0 {
        Some(out)
    } else {
...
pub fn read_type_base(buf: &[u8]) -> u32 {
    ...
    unsafe { tintbox_oracle_read_type_base(buf.as_ptr(), buf.len() as u32, &mut out) };
    out
}
...
pub fn read_alignment(buf: &[u8], offset: u32) -> (bool, u32) {
    ...
    let ok =
        unsafe { tintbox_oracle_read_alignment(buf.as_ptr(), buf.len() as u32, offset, &mut tell) };
    (ok != 0, tell)
}
...
pub fn tag_true_type(buf: &[u8], sig: u32) -> Option<u32> {
    // SAFETY: buf/len describe a valid readable slice C only reads.
    let t = unsafe { tintbox_oracle_tag_true_type(buf.as_ptr(), buf.len() as u32, sig) };
    if t == 0 {
        None
    } else {
        Some(t)
...
/// distinguishing "tintbox bug" from "both stacks correctly reject this tag".
pub fn tag_read_succeeds(buf: &[u8], sig: u32) -> bool {
    ...
    let ok = unsafe { tintbox_oracle_tag_read_succeeds(buf.as_ptr(), buf.len() as u32, sig) };
    ok != 0
}
...
pub fn read_tag_xyz(buf: &[u8], sig: u32) -> Option<[f64; 3]> {
    ...
    let ok = unsafe {
        tintbox_oracle_read_tag_xyz(buf.as_ptr(), buf.len() as u32, sig, out.as_mut_ptr())
    };
    if ok != 0 {
        Some(out)
    } else {
...
pub fn read_tag_s15f16(buf: &[u8], sig: u32, n: usize) -> Option<Vec<f64>> {
    ...
    let got = unsafe {
        tintbox_oracle_read_tag_s15f16(
            buf.as_ptr(),
            buf.len() as u32,
            sig,
            out.as_mut_ptr(),
...
pub fn read_tag_signature(buf: &[u8], sig: u32) -> Option<u32> {
    ...
    let ok =
        unsafe { tintbox_oracle_read_tag_signature(buf.as_ptr(), buf.len() as u32, sig, &mut out) };
    if ok != 0 {
        Some(out)
    } else {
        None
...
pub fn read_tag_datetime(buf: &[u8], sig: u32) -> Option<[u16; 6]> {
    ...
    let ok = unsafe {
        tintbox_oracle_read_tag_datetime(buf.as_ptr(), buf.len() as u32, sig, out.as_mut_ptr())
    };
    if ok != 0 {
        Some(out)
    } else {
...
pub fn read_tag_chromaticity(buf: &[u8], sig: u32) -> Option<[f64; 6]> {
    ...
    // array C writes only when it returns nonzero.
    let ok = unsafe {
        tintbox_oracle_read_tag_chromaticity(buf.as_ptr(), buf.len() as u32, sig, out.as_mut_ptr())
    };
    if ok != 0 {
        Some(out)
    } else {
...
pub fn read_tag_colorant_order(buf: &[u8], sig: u32) -> Option<Vec<u8>> {
    ...
    let n = unsafe {
        tintbox_oracle_read_tag_colorant_order(
            buf.as_ptr(),
            buf.len() as u32,
            sig,
            out.as_mut_ptr(),
...
pub fn read_tag_measurement(buf: &[u8], sig: u32) -> Option<([u32; 3], [f64; 4])> {
    ...
    let ok = unsafe {
        tintbox_oracle_read_tag_measurement(
            buf.as_ptr(),
            buf.len() as u32,
            sig,
            u.as_mut_ptr(),
...
/// normalization tintbox applies to the identical units.
...
pub fn mlu_count(buf: &[u8], sig: u32) -> Option<u32> {
    // SAFETY: buf/len describe a valid readable slice C only reads.
    let n = unsafe { tintbox_oracle_mlu_count(buf.as_ptr(), buf.len() as u32, sig) };
    if n >= 0 {
        Some(n as u32)
    } else {
        None
...
/// normalization tintbox's MLU reader applies. Compare against an tintbox `Mlu` by
...
pub fn read_tag_named_color2(buf: &[u8], sig: u32) -> Option<OracleNamedColorList> {
    ...
    let ok = unsafe {
        tintbox_oracle_named_color2_info(
            buf.as_ptr(),
            buf.len() as u32,
            sig,
            counts.as_mut_ptr(),
    ...
    for idx in 0..n_colors {
        ...
        let cok = unsafe {
            tintbox_oracle_named_color2_color(
                buf.as_ptr(),
                buf.len() as u32,
                sig,
                idx,
...
pub fn read_tag_seq_desc(buf: &[u8], sig: u32) -> Option<Vec<OracleSeqDescItem>> {
    // SAFETY: buf/len describe a valid readable slice C only reads.
    let n = unsafe { tintbox_oracle_seq_count(buf.as_ptr(), buf.len() as u32, sig) };
    if n < 0 {
        return None;
    }
    let cap = 1usize << 16;
...
/// against an tintbox `Dict` (which stores on-disk order).
#[derive(Clone, Debug, PartialEq, Eq)]
...
/// with no entries); the test maps an empty `OracleMlu` to `None` to match tintbox,
/// which stores `None` for a 0-size/absent cell.
pub fn read_tag_dict(buf: &[u8], sig: u32) -> Option<OracleDict> {
    // SAFETY: buf/len describe a valid readable slice C only reads.
    let n = unsafe { tintbox_oracle_dict_count(buf.as_ptr(), buf.len() as u32, sig) };
    if n < 0 {
        return None;
    }
    let cap = 1usize << 16;
...
/// tone-curve-backed. This is the bit-exact reference for an tintbox `Tag::Curve`'s
...
pub fn lut_channels(buf: &[u8], sig: u32) -> Option<(u32, u32)> {
    ...
    let ok = unsafe {
        tintbox_oracle_lut_channels(buf.as_ptr(), buf.len() as u32, sig, &mut n_in, &mut n_out)
    };
    if ok != 0 {
        Some((n_in, n_out))
    } else {
...
pub fn read_lut_channels(buf: &[u8], which: ReadLut, intent: u32) -> Option<(u32, u32)> {
    ...
    let ok = unsafe {
        tintbox_oracle_read_lut_channels(
            buf.as_ptr(),
            buf.len() as u32,
            which as u32,
            intent,
...
pub fn read_lut_eval_float(
    ...
    let ok = unsafe {
        tintbox_oracle_read_lut_eval_float(
            buf.as_ptr(),
            buf.len() as u32,
            which as u32,
            intent,
...
pub fn reverse_tabulated16_eval_float(table: &[u16], xs: &[f32]) -> Option<Vec<f32>> {
    ...
    let ok = unsafe {
        tintbox_oracle_reverse_tabulated16_eval_float(
            table.as_ptr(),
            table.len() as u32,
            xs.as_ptr(),
            xs.len() as u32,
...
/// the bit-exact reference for an tintbox transform built from the same chain.
...
pub fn transform_eval_float(
    ...
    let ok = unsafe {
        tintbox_oracle_transform_eval_float(
            bufs.as_ptr(),
            lens.as_ptr(),
            n as u32,
            intents.as_ptr(),
...
pub fn transform_eval_16(
    ...
    // freed inside the call.
    let ok = unsafe {
        tintbox_oracle_transform_eval_16(
            bufs.as_ptr(),
            lens.as_ptr(),
            n as u32,
            intents.as_ptr(),
...
///
/// This is the genuine serializer-vs-serializer reference: tintbox builds the SAME
...
pub fn save_basic_profile(link: bool) -> Option<Vec<u8>> {
    ...
    let needed =
        unsafe { tintbox_oracle_save_basic_profile(link as i32, core::ptr::null_mut(), 0) };
    if needed == 0 {
        return None;
    }
    ...
    let written =
        unsafe { tintbox_oracle_save_basic_profile(link as i32, out.as_mut_ptr(), needed) };
    if written == 0 {
        return None;
    }
...
/// failure. tintbox constructs the identical structure; the bytes must match.
pub fn save_single_tag(which: i32) -> Option<Vec<u8>> {
    // SAFETY: out=NULL size query; C only reads `which` and returns the length.
    let needed = unsafe { tintbox_oracle_save_single_tag(which, core::ptr::null_mut(), 0) };
    if needed == 0 {
        return None;
    }
    let mut out = vec![0u8; needed as usize];
    ...
    let written = unsafe { tintbox_oracle_save_single_tag(which, out.as_mut_ptr(), needed) };
    if written == 0 {
        return None;
    }
    out.truncate(written as usize);
...
/// bytes, or `None` on failure. tintbox constructs the identical structure; the
/// bytes must match.
pub fn save_curve_mlu_tag(which: i32) -> Option<Vec<u8>> {
    // SAFETY: out=NULL size query; C only reads `which` and returns the length.
    let needed = unsafe { tintbox_oracle_save_curve_mlu_tag(which, core::ptr::null_mut(), 0) };
    if needed == 0 {
        return None;
    }
    let mut out = vec![0u8; needed as usize];
    // SAFETY: `out` has exactly `needed` bytes; C writes at most `cap` and bails
    // if needed > cap, returning the count written.
    let written = unsafe { tintbox_oracle_save_curve_mlu_tag(which, out.as_mut_ptr(), needed) };
    if written == 0 {
        return None;
    }
    out.truncate(written as usize);
...
/// whole-profile bytes, or `None` on failure. tintbox parses the same bytes and
...
/// tintbox constructs the identical pipeline; the bytes must match. Exercises the
...
pub fn save_mpe_tag() -> Option<Vec<u8>> {
    ...
    let needed = unsafe { tintbox_oracle_save_mpe_tag(core::ptr::null_mut(), 0) };
    if needed == 0 {
        return None;
    }
    let mut out = vec![0u8; needed as usize];
    // SAFETY: `out` has exactly `needed` bytes; C writes at most `cap`.
    let written = unsafe { tintbox_oracle_save_mpe_tag(out.as_mut_ptr(), needed) };
    if written == 0 {
        return None;
    }
    out.truncate(written as usize);
...
/// Returns the bytes, or `None` on failure. tintbox's `build_*` constructs the same
/// in-memory structure; the two byte streams must match byte-for-byte.
pub fn save_virtual_profile(which: i32) -> Option<Vec<u8>> {
    // SAFETY: out=NULL size query; C only reads `which` and returns the length.
    let needed = unsafe { tintbox_oracle_save_virtual_profile(which, core::ptr::null_mut(), 0) };
    if needed == 0 {
        return None;
    }
    let mut out = vec![0u8; needed as usize];
    // SAFETY: `out` has exactly `needed` bytes; C writes at most `cap` and bails
    // if needed > cap, returning the count written.
    let written = unsafe { tintbox_oracle_save_virtual_profile(which, out.as_mut_ptr(), needed) };
    if written == 0 {
        return None;
    }
    out.truncate(written as usize);
...
pub fn named_transform_16(
    ...
    let ok = unsafe {
        tintbox_oracle_named_transform_16(
            named_bytes.as_ptr(),
...
unsafe extern "C" {
    fn tintbox_oracle_detect_tac(bytes: *const u8, len: u32) -> f64;

    #[allow(clippy::too_many_arguments)]
    fn tintbox_oracle_proofing_transform_packed(
        in_bytes: *const u8,
        in_len: u32,
        out_bytes: *const u8,
        out_len: u32,
    ...
    #[allow(clippy::too_many_arguments)]
    fn tintbox_oracle_proofing_transform_packed_alarm(
        in_bytes: *const u8,
        in_len: u32,
        out_bytes: *const u8,
        out_len: u32,
...
pub fn detect_tac(bytes: &[u8]) -> f64 {
    ...
    // freed inside the call.
    unsafe { tintbox_oracle_detect_tac(bytes.as_ptr(), bytes.len() as u32) }
}
...
pub fn proofing_transform_packed(
    ...
    let ok = unsafe {
        tintbox_oracle_proofing_transform_packed(
...
pub fn proofing_transform_packed_alarm(
    ...
    let ok = unsafe {
        tintbox_oracle_proofing_transform_packed_alarm(
            input_profile.as_ptr(),
            input_profile.len() as u32,
            output_profile.as_ptr(),
            output_profile.len() as u32,
...
pub fn gbd_check(add_lab: &[[f64; 3]], check_lab: &[[f64; 3]]) -> Vec<bool> {
    ...
    assert!(ok != 0, "tintbox_oracle_gbd_check failed");
...
///   cargo test -p tintbox-oracle --release transcendental_parity_probe -- --nocapture --ignored
...
unsafe extern "C" {
    fn tintbox_oracle_it8_load(bytes: *const u8, len: u32) -> usize;
    fn tintbox_oracle_it8_free(h: usize);
    fn tintbox_oracle_it8_table_count(h: usize) -> u32;
    fn tintbox_oracle_it8_set_table(h: usize, n: u32) -> i32;
    fn tintbox_oracle_it8_sheet_type(h: usize) -> *const std::os::raw::c_char;
    fn tintbox_oracle_it8_get_property(
        h: usize,
        key: *const std::os::raw::c_char,
    ) -> *const std::os::raw::c_char;
    fn tintbox_oracle_it8_get_property_dbl(h: usize, key: *const std::os::raw::c_char) -> f64;
    fn tintbox_oracle_it8_num_samples(h: usize) -> i32;
    fn tintbox_oracle_it8_enum_properties(
        h: usize,
        out: *mut *const std::os::raw::c_char,
        cap: u32,
    ) -> u32;
    fn tintbox_oracle_it8_data_format(h: usize, col: i32) -> *const std::os::raw::c_char;
    fn tintbox_oracle_it8_get_data_rowcol(
        h: usize,
        row: i32,
        col: i32,
    ) -> *const std::os::raw::c_char;
    fn tintbox_oracle_it8_get_data_rowcol_dbl(h: usize, row: i32, col: i32) -> f64;
    fn tintbox_oracle_it8_get_data(
        h: usize,
        patch: *const std::os::raw::c_char,
        sample: *const std::os::raw::c_char,
    ) -> *const std::os::raw::c_char;
    fn tintbox_oracle_it8_get_data_dbl(
        h: usize,
        patch: *const std::os::raw::c_char,
        sample: *const std::os::raw::c_char,
    ) -> f64;
    fn tintbox_oracle_it8_patch_name(h: usize, patch: i32) -> *const std::os::raw::c_char;
    fn tintbox_oracle_it8_save(h: usize, out: *mut u8, cap: u32) -> u32;
}
...
impl It8 {
    ...
    /// accept/reject decision tintbox must agree with).
    pub fn load(bytes: &[u8]) -> Option<It8> {
        ...
        let h = unsafe { tintbox_oracle_it8_load(bytes.as_ptr(), bytes.len() as u32) };
        if h == 0 {
            None
        } else {
            Some(It8 { h })
    ...
    pub fn table_count(&self) -> u32 {
        ...
        unsafe { tintbox_oracle_it8_table_count(self.h) }
    }

    /// `cmsIT8SetTable`; returns the new index or `-1`.
    pub fn set_table(&self, n: u32) -> i32 {
        // SAFETY: live handle.
        unsafe { tintbox_oracle_it8_set_table(self.h, n) }
    }
    ...
    pub fn sheet_type(&self) -> Option<String> {
        ...
        unsafe { opt_cstr(tintbox_oracle_it8_sheet_type(self.h)) }
    }
    ...
    pub fn get_property(&self, key: &str) -> Option<String> {
        ...
        unsafe { opt_cstr(tintbox_oracle_it8_get_property(self.h, k.as_ptr())) }
    }
    ...
    pub fn get_property_dbl(&self, key: &str) -> f64 {
        ...
        // SAFETY: live handle; `k` is a valid NUL-terminated string C only reads.
        unsafe { tintbox_oracle_it8_get_property_dbl(self.h, k.as_ptr()) }
    }

    /// `cmsIT8EnumDataFormat` field count for the active table.
    pub fn num_samples(&self) -> i32 {
        // SAFETY: live handle.
        unsafe { tintbox_oracle_it8_num_samples(self.h) }
    }
    ...
    pub fn enum_properties(&self) -> Vec<String> {
        ...
        let n = unsafe { tintbox_oracle_it8_enum_properties(self.h, std::ptr::null_mut(), 0) };
        ...
        unsafe { tintbox_oracle_it8_enum_properties(self.h, ptrs.as_mut_ptr(), n) };
        ptrs.into_iter()
    ...
    pub fn data_format(&self, col: i32) -> Option<String> {
        ...
        unsafe { opt_cstr(tintbox_oracle_it8_data_format(self.h, col)) }
    }

    /// `cmsIT8GetDataRowCol` (string), `None` if out of range.
    pub fn get_data_rowcol(&self, row: i32, col: i32) -> Option<String> {
        // SAFETY: live handle; borrowed result copied here.
        unsafe { opt_cstr(tintbox_oracle_it8_get_data_rowcol(self.h, row, col)) }
    }

    /// `cmsIT8GetDataRowColDbl`.
    pub fn get_data_rowcol_dbl(&self, row: i32, col: i32) -> f64 {
        // SAFETY: live handle.
        unsafe { tintbox_oracle_it8_get_data_rowcol_dbl(self.h, row, col) }
    }
    ...
    pub fn get_data(&self, patch: &str, sample: &str) -> Option<String> {
        ...
        unsafe { opt_cstr(tintbox_oracle_it8_get_data(self.h, p.as_ptr(), s.as_ptr())) }
    }
    ...
    pub fn get_data_dbl(&self, patch: &str, sample: &str) -> f64 {
        ...
        unsafe { tintbox_oracle_it8_get_data_dbl(self.h, p.as_ptr(), s.as_ptr()) }
    }

    /// `cmsIT8GetPatchName` for the active table, `None` if no SAMPLE_ID data.
    pub fn patch_name(&self, patch: i32) -> Option<String> {
        // SAFETY: live handle; borrowed result copied here.
        unsafe { opt_cstr(tintbox_oracle_it8_patch_name(self.h, patch)) }
    }
    ...
    pub fn save(&self) -> Option<Vec<u8>> {
        ...
        let needed = unsafe { tintbox_oracle_it8_save(self.h, std::ptr::null_mut(), 0) };
        if needed == 0 {
            return None;
        }
        let mut buf = vec![0u8; needed as usize];
        ...
        let written = unsafe { tintbox_oracle_it8_save(self.h, buf.as_mut_ptr(), needed) };
        if written == 0 {
            return None;
        }
...
impl Drop for It8 {
    fn drop(&mut self) {
        ...
        unsafe { tintbox_oracle_it8_free(self.h) }
    }
}
...
impl OracleCam02 {
    ...
    pub fn forward(&self, xyz: [f64; 3]) -> [f64; 3] {
        ...
        unsafe { tintbox_oracle_cam02_forward(self.handle, xyz.as_ptr(), out.as_mut_ptr()) };
        out
    }
    ...
    pub fn reverse(&self, jch: [f64; 3]) -> [f64; 3] {
        ...
        // the C only reads, and `out` is a writable [3] the C fills.
        unsafe { tintbox_oracle_cam02_reverse(self.handle, jch.as_ptr(), out.as_mut_ptr()) };
        out
    }
}
