...
mod tests {
    use super::*;
    use rcms_oracle::{assert_f64_bits_eq, Rng};
    ...
    fn f_matches_oracle_via_xyz_to_lab() {
        ...
        for i in 0..200_000u32 {
            ...
            for wp in wps() {
                ...
                let c = rcms_oracle::xyz2lab(wp_arr(wp), &[xyz.x, xyz.y, xyz.z]);
    ...
    fn lab_to_xyz_matches_oracle() {
        ...
        for i in 0..200_000u32 {
            ...
            for wp in wps() {
                ...
                let c = rcms_oracle::lab2xyz(wp_arr(wp), &[lab.l, lab.a, lab.b]);
    ...
    fn xyz_to_xyy_matches_oracle() {
        ...
        for i in 0..200_000u32 {
            ...
            let c = rcms_oracle::xyz2xyy(&[xyz.x, xyz.y, xyz.z]);
        ...
        let r = xyz_to_xyy(z);
        let c = rcms_oracle::xyz2xyy(&[0.0, 0.0, 0.0]);
    ...
    fn xyy_to_xyz_matches_oracle() {
        ...
        for i in 0..200_000u32 {
            ...
            let c = rcms_oracle::xyy2xyz(&[xyy.x, xyy.y, xyy.yy]);
    ...
    fn lab_to_lch_matches_oracle() {
        ...
        for i in 0..200_000u32 {
            ...
            let c = rcms_oracle::lab2lch(&[lab.l, lab.a, lab.b]);
    ...
    fn lch_to_lab_matches_oracle() {
        ...
        for i in 0..200_000u32 {
            ...
            let c = rcms_oracle::lch2lab(&[lch.l, lch.c, lch.h]);
    ...
    fn lab_v2_encode_decode_matches_oracle() {
        ...
        for i in 0..300_000u32 {
            ...
            let c = rcms_oracle::lab_enc2float_v2(&w);
        ...
        for i in 0..300_000u32 {
            ...
            let c = rcms_oracle::float2lab_enc_v2(&[lab.l, lab.a, lab.b]);
    ...
    fn lab_v4_encode_decode_matches_oracle() {
        ...
        for i in 0..300_000u32 {
            ...
            let c = rcms_oracle::lab_enc2float_v4(&w);
            assert_f64_bits_eq(r.l, c[0], (i, "L", w));
            assert_f64_bits_eq(r.a, c[1], (i, "a", w));
            assert_f64_bits_eq(r.b, c[2], (i, "b", w));
        }
        ...
        for i in 0..300_000u32 {
            ...
            let c = rcms_oracle::float2lab_enc_v4(&[lab.l, lab.a, lab.b]);
    ...
    fn xyz_encode_decode_matches_oracle() {
        ...
        for i in 0..300_000u32 {
            ...
            let c = rcms_oracle::xyz_enc2float(&w);
        ...
        for i in 0..300_000u32 {
            ...
            let c = rcms_oracle::float2xyz_enc(&[xyz.x, xyz.y, xyz.z]);
